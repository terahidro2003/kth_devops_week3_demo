...
while true; do
    printf '\n======================================================\n'
    printf '  CANARY DEMO - Local rehearsal\n'
    printf '======================================================\n'
    printf '  1. Run app and generator tests in Docker\n'
    printf '  2. Build both images: demo:v1 and demo:v2\n'
    ...
    case "$selection" in
        1)
            ...
            ;;
        2)
            printf '\nBuilding demo:v1 and demo:v2. This does not start the apps.\n'
        ...
        3)
            if run_docker up -d --no-build app app-bad; then
                ...
                printf 'v1: http://localhost:8082 - fast responses (latency-ms=0)\n'
                printf 'v2: http://localhost:8083 - delayed responses (latency-ms=1500)\n'
        ...
        7)
            ...
            printf '  1. Local v1 - fast HTTP 200\n'
            printf '  2. Local v2 - delayed HTTP 200\n'
